...
const Contact: React.FC<ContactProps> = (props) => {
  return (
    <div>
      <div className="py-20 lg:mr-48">
        <div className="flex flex-col md:flex-row gap-10">
          <div className="flex flex-col gap-10 lg:w-1/2">
            <h2 className="pl-5 py-5 border-l-4 border-l-blue-600">
              Contact
            </h2>
          ...
          <div className="lg:w-1/2">
            <form className="flex flex-col gap-5 items-end">
              <input
                ...
                className="bg-[#252525] outline-none p-3 pl-5 rounded-lg w-full lg:w-10/12 placeholder:text-white"
              />
              <input
